...
export const mockTasks: Task[] = [
  // ============================================
  // BRIEF TASKS (source: 'brief')
  // ============================================
  { id: "brief_task_001", briefId: "brief-001", title: "Summer Campaign 2025", type: "brief", status: "in_progress", priority: "high", assignedTo: ["2", "3"], assignedBy: "1", createdAt: "2025-12-15T09:00:00Z", deadline: addDays(3), appName: "Fashion Show", campaignName: "Summer 2025", description: "Campaign lớn cho summer", progress: 40, source: "brief", briefStatus: "in_progress", linkedBriefTitle: "Summer Campaign 2025" },
  { id: "brief_task_002", briefId: "brief-002", title: "Gaming App UA Campaign", type: "brief", status: "pending", priority: "urgent", assignedTo: ["4", "5"], assignedBy: "1", createdAt: "2025-12-17T09:00:00Z", deadline: addDays(1), appName: "Puzzle Master", campaignName: "Q1 UA Push", description: "UA campaign Q1", progress: 10, source: "brief", briefStatus: "confirmed", linkedBriefTitle: "Gaming App UA Campaign" },
  { id: "brief_task_003", briefId: "brief-003", title: "Holiday Campaign Q4", type: "brief", status: "review", priority: "high", assignedTo: ["2"], assignedBy: "1", createdAt: "2025-12-10T09:00:00Z", deadline: addDays(0), appName: "Meditation Pro", campaignName: "Holiday Q4", description: "Holiday campaign", progress: 85, source: "brief", briefStatus: "waiting_ua_review", linkedBriefTitle: "Holiday Campaign Q4" },

  // ============================================
  // ORDER TASKS (source: 'order')
  // ============================================
  { id: "order_task_001", briefId: "brief-001", title: "Summer Beach Video - Design", type: "order", status: "in_progress", priority: "high", assignedTo: ["d-1", "d-2"], assignedBy: "c-lead", createdAt: "2025-12-17T09:00:00Z", deadline: addDays(2), appName: "Fashion Show", campaignName: "Summer 2025", progress: 50, source: "order", conceptId: "concept_001", orderId: "concept_001-0", teamType: "design", orderStatus: "in_progress", linkedBriefTitle: "Summer Campaign 2025", linkedConceptTitle: "Summer Beach Campaign - Video Concept" },
  { id: "order_task_002", briefId: "brief-003", title: "Gaming Endcard - AI Producer", type: "order", status: "completed", priority: "medium", assignedTo: ["ai-1", "ai-2"], assignedBy: "c-lead", createdAt: "2025-12-18T09:00:00Z", deadline: addDays(-2), completedAt: addDays(-3), appName: "Puzzle Master", campaignName: "Q1 UA Push", progress: 100, source: "order", conceptId: "concept_002", orderId: "concept_002-0", teamType: "ai_producer", orderStatus: "completed", linkedBriefTitle: "Gaming App UA Campaign", linkedConceptTitle: "Gaming App Endcard Series" },
  { id: "order_task_003", briefId: "brief-004", title: "Influencer Kit - Art & Stylist", type: "order", status: "review", priority: "urgent", assignedTo: ["a-1", "a-2"], assignedBy: "c-lead", createdAt: "2025-12-16T09:00:00Z", deadline: addDays(1), appName: "Fashion Show", campaignName: "Influencer Q1", progress: 0, source: "order", conceptId: "concept_005", orderId: "concept_005-0", teamType: "art_stylist", orderStatus: "returned", linkedBriefTitle: "Influencer Campaign Q1", linkedConceptTitle: "Influencer Kit Visual Identity" },

  // ============================================
  // STANDALONE TASKS (existing tasks - source: 'standalone')  
  // ============================================
  // Dec 8 - 4 tasks
