...
import { Home, CheckSquare, FileText, Target, Bell, Menu, ChevronLeft, ChevronRight, User, BarChart3, AppWindow, Briefcase } from 'lucide-react'
...
export default function RequestsLayout({
  ...
  const [activeIcon, setActiveIcon] = useState<string>("requests")
  ...
  const secondaryMenus = {
    requests: [
      { id: "timekeeping", label: "Timekeeping", href: "/requests" },
      { id: "my-requests", label: "My Requests", href: "#" },
      { id: "approvals", label: "Approvals", href: "#" },
      { id: "templates", label: "Templates", href: "#" },
      { id: "history", label: "History", href: "#" },
    ],
    applications: [
      { id: "application1", label: "Application 1", href: "/applications/1" },
      { id: "application2", label: "Application 2", href: "/applications/2" },
      { id: "application3", label: "Application 3", href: "/applications/3" },
    ],
  }
